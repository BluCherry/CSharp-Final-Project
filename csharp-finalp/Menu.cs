...
public class Menu
{
        ...
        while (quit == false)
        {
            ...
            switch (command)
            {
                case "1":
                    ...
                    PrintallEntries printAll = new PrintallEntries();
                    printAll.PrintAllEntries();
                    //prints all entries
                    //quit = true;
                    break;
                case "2":
                    Console.WriteLine("Printing out all music tracks");
                    PrintAllMusicTracks printMusic = new PrintAllMusicTracks();
                    printMusic.PrintMusicTracks();
                    //PrintAllMusicTracks();
                ...
                case "3":
                    ...
                    PrintAllAudiobooks printAudio = new PrintAllAudiobooks();
                    printAudio.PrintAudiobooks();
                ...
                case "4":
                    ...
                    PrintAllTVEpisodes printTV = new PrintAllTVEpisodes();
                    printTV.PrintTVEpisodes();
                ...
                case "5":
                    ...
                    Console.WriteLine("Printing out all entries by: " + creator);
    ...
    public class PrintallEntries
    
    {
        public void PrintAllEntries()
        {
            using (StreamReader sr = new StreamReader (".\\CNoteSharpDatabase.csv"))
            {
                string? line;
    ...
    public class PrintAllMusicTracks
    {
        public void PrintMusicTracks()
        {
            using (StreamReader sr = new StreamReader(".\\CNoteSharpDatabase.csv"))
            {
                string? line;
    ...
    public class PrintAllAudiobooks
    {
    ...
    public class PrintAllTVEpisodes
    {
        public void PrintTVEpisodes()
        {
            using (StreamReader sr = new StreamReader(".\\CNoteSharpDatabase.csv"))
            {
                string? line;
    ...
    {
        public static void Remove(string filePath, string title)
        {
            var lines = File.ReadAllLines(filePath).ToList();
            lines = lines.Where(line => !line.Contains(title)).ToList();
